...
export function DronePovPanel({
  ...
  return (
    <div className="border-border bg-card/95 absolute bottom-3 left-1/2 z-40 w-[380px] -translate-x-1/2 border backdrop-blur">
      ...
      <div className="relative h-[240px] overflow-hidden bg-[hsl(220_25%_8%)]">
        <div
        ...
        <div className="pointer-events-none absolute inset-x-2 top-2 flex items-center justify-between font-mono text-[9px] uppercase tracking-wider text-white/90 [text-shadow:0_1px_2px_rgba(0,0,0,0.85)]">
          <span>EO · gimbal -25°</span>
          <span>REC · 1080p</span>
        </div>
